...
urlpatterns = [
    ...
    path(
        "invoicing/general/quotations/",
        views.general_quotation_list,
        name="general_quotation_list",
    ),
    path(
        "invoicing/general/quotations/create/",
        views.general_quotation_create,
        name="general_quotation_create",
    ),
    path(
        "invoicing/general/quotations/<int:pk>/",
        views.general_quotation_detail,
        name="general_quotation_detail",
    ),
    path(
        "invoicing/general/quotations/<int:pk>/update/",
        views.general_quotation_update,
    ...
    path(
        "invoicing/general/quotations/<int:pk>/html-preview/",
        views.general_quotation_html_preview,
        name="general_quotation_html_preview",
    ),
    path(
        "invoicing/general/quotations/<int:pk>/pdf/",
        views.general_quotation_pdf,
        name="general_quotation_pdf",
    ),
    path(
        "invoicing/general/invoices/",
        views.general_invoice_list,
        name="general_invoice_list",
    ),
    path(
        "invoicing/general/invoices/create/",
        views.general_invoice_create,
        name="general_invoice_create",
    ),
    path(
        "invoicing/general/invoices/<int:pk>/",
        views.general_invoice_detail,
        name="general_invoice_detail",
    ),
    path(
        "invoicing/general/invoices/<int:pk>/update/",
        views.general_invoice_update,
    ...
    path(
        "invoicing/general/invoices/<int:pk>/html-preview/",
        views.general_invoice_html_preview,
        name="general_invoice_html_preview",
    ),
    path(
        "invoicing/general/invoices/<int:pk>/pdf/",
        views.general_invoice_pdf,
        name="general_invoice_pdf",
    ),
    path(
        "invoicing/general/receipts/",
        views.general_receipt_list,
        name="general_receipt_list",
    ),
    path(
    ...
    path(
        ...
        views.general_receipt_html_preview,
        name="general_receipt_html_preview",
    ),
    path(
        "invoicing/general/receipts/<int:pk>/pdf/",
        views.general_receipt_pdf,
        name="general_receipt_pdf",
    ),
    path(
