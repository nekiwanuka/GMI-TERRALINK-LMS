...
for _env_name in (".env", ".emnv"):
    _load_env_file(BASE_DIR / _env_name)
...
# Email / OTP delivery. Use the console backend for local development only
# when SMTP has not been configured explicitly.
